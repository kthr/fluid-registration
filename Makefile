...
CXX=g++
CXXFLAGS=-g -fopenmp -I/opt/intel/tbb/include -Ilib -Ilib/CImg-1.5.0 -Isrc/filter -Isrc/fourier_transform -Isrc/registration -Isrc/segmentation -Isrc/templates -Isrc/utilities
LFLAGS=-g -L/opt/intel/composer_xe_2011_sp1/lib/ -lirc -limf -liomp5 -L/opt/intel/tbb/lib -ltbb -L/usr/X11R6/lib -lm -lpthread -lX11 -Llib/MacOSX-x86-64 -lfftw3 -lstdc++
